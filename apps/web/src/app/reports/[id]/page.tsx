  ...
  return (
    ...
    >
      ...
      <section className="report-section" aria-label="온체인 증적">
        <h2>온체인 증적</h2>
        {report.onchain_evidence.map((evidence) => (
          <BlockReceipt key={`${evidence.tx_hash}-${evidence.log_index}`} evidence={evidence} />
        ))}
      </section>

      <section className="report-section" aria-label="계보">
        <h2>입력과 룰 버전</h2>
