    ...
    actions: [
      {
        ...
        source_ids: ["SRC-FSC-MALAPP", "SRC-FSC-CARDNEWS"],
  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        prerequisite: ["의심 기기와 분리된 안전한 기기에서 실행"],
        required_followup: [],
        source_ids: ["SRC-FSC-MALAPP", "SRC-KISA-PHISHING"],
        template_versions: ["TPL-SAFE-DEVICE-001@1.0"],
      },
    ],
    ...
    actions: [
      {
        ...
        prerequisite: [],
        required_followup: [],
        source_ids: ["SRC-FSS-1332", "SRC-FSC-10RULES"],
      ...
      },
      {
        ...
        prerequisite: [],
        required_followup: [],
        source_ids: ["SRC-FSS-1332", "SRC-FSC-1332"],
        template_versions: ["TPL-OFFICIAL-VERIFY-001@1.0"],
      },
    ],
